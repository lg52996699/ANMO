...
unsigned char byte_read(u16 EE_address)
{
	EA = 0;		//禁止中断
...
// 版本: V1.0, 2013-5-10
//========================================================================
void SectorErase(u16 EE_address)
{
	EA = 0;		//禁止中断
...
//========================================================================
// 函数: void EEPROM_write_n(u16 EE_address,u8 DataAddress)
...
// 版本: V1.0, 2012-10-22
//========================================================================
void byte_write(u16 EE_address,u8 DataAddress)
{
	EA = 0;		//禁止中断
	ISP_CONTR = (ISP_EN + ISP_WAIT_FREQUENCY);	//设置等待时间，允许ISP/IAP操作，送一次就够
